        ...
        <div class="right">
            <div class="class-info">
                ...
                <div style="width: 100%; margin: 0; padding: 0;     box-sizing: border-box; ">
                    <form class="choose-type"
                        action="{{ route('lecture.update', ['id' => $lecture->msbg, 'malop' => $class->malop]) }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST') <!-- hoặc PUT nếu bạn muốn dùng method PUT -->
                        ...
                        <div class="upload-filee">
                            <div class="link">
                                ...
                                <input id="link-video" name="link_paths" type="text"
                                    ...
                                    value="{{ old('link_paths', $lecture->link_paths) }}">
                            </div>
                            <div class="file">
                        ...
                        <div class="setting">
                            <label for="tenbg">Tên bài giảng</label>
                            <input type="text" name="tenbg" class="field" placeholder="Tên bài giảng"
                                value="{{ old('tenbg', $lecture->tenbg) }}">

                            <label for="noidungbg">Mô tả</label>
                            <textarea name="noidungbg" class="field-2" placeholder="Mô tả">{{ old('noidungbg', $lecture->noidungbg) }}</textarea>
